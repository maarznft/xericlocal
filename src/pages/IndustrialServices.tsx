  ...
  const services = [
    {
      ...
      description: "High-precision manufacturing services delivering exact specifications for critical components across industries.",
      features: ["CNC machining", "Multi-axis capabilities", "Tight tolerance control", "Quality assurance", "Material versatility"]
    },
    {
      title: "Critical Component Fabrication",
      description: "Specialized fabrication of mission-critical components for aerospace, defense, and industrial applications.",
      features: ["Custom component design", "High-strength materials", "Certified processes", "Failure analysis", "Rapid prototyping"]
    }
  ];
            ...
            <div className="space-y-6">
              ...
              <BlurFade delay={0.3} inView>
                <p className="text-lg md:text-xl text-foreground/70 leading-relaxed max-w-3xl mx-auto">
                  Precision manufacturing and fabrication services delivering high-quality components 
                  and solutions for critical industrial applications.
                </p>
              </BlurFade>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <BlurFade delay={0.2} inView>
              <p className="text-lg text-foreground/70 leading-relaxed">
                Trust XERIC for precision manufacturing services that meet the highest standards 
                of quality and reliability for your critical components.
              </p>
            </BlurFade>
            <BlurFade delay={0.3} inView>
